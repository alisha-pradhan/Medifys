...
import 'package:medifys_app/pages/med_rem/med_page_util/med_menu_items.dart';

class MedPopBtn extends StatelessWidget{
  const MedPopBtn({super.key});
  ...
  Widget build(BuildContext context){
    ...
    onTap:() => showPopover(
      context: context, 
      bodyBuilder: (context) => MedMenuItems(),    //context points to menu_items.dart
      width: 250,
      height:150,
